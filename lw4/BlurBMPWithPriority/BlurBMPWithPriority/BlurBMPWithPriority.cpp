...
{
	std::cout << "Usage: BlurBMPWithPriority.exe <image to blur .bmp> <blurred image .bmp> <thread count> <core count> <priorities>"
		<< "Priorities: 1 for above_normal, 0 for normal, -1 for below_normal" << std::endl;
}
